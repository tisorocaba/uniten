...
class Menu extends Lumine_Base {
    ...
    protected function _initialize()
    {
        ...
        $this->_addField('pag', 'pag', 'varchar', 40, array('notnull' => true, 'default' => ''));
        $this->_addForeignRelation('usuarios', self::MANY_TO_MANY, 'Usuario', 'id', 'usuario_permissao', 'menu_id', null);
    }
