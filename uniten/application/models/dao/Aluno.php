...
class Aluno extends Lumine_Base {
    ...
    public $condicaoEspecialProva;
    public $condicaoEspecialQual;
    public $pessoasMoradia;
    ...
    protected function _initialize()
    {
        ...
        $this->_addField('rg', 'rg', 'varchar', 45, array());
        ...
        $this->_addField('dddCelular', 'dddCelular', 'int', 2, array());
        $this->_addField('celular', 'celular', 'varchar', 9, array());
        
        $this->_addField('dddContato', 'dddContato', 'int', 2, array());
        $this->_addField('telefoneContato', 'telefoneContato', 'varchar', 9, array());
        ...
        $this->_addField('renda', 'renda', 'int', 1, array());
        $this->_addField('cor', 'cor', 'varchar', 50, array());
        $this->_addField('possuiDeficiencia', 'possui_deficiencia', 'char', 1, array());
        $this->_addField('tipoDeficiencia', 'tipo_deficiencia', 'varchar', 85, array());
        $this->_addField('condicaoEspecialProva', 'condicao_especial_prova', 'char', 1, array());
        $this->_addField('condicaoEspecialQual', 'condicao_especial_qual', 'varchar', 150, array());
        $this->_addField('pessoasMoradia', 'pessoas_moradia', 'int', 3, array());
        
        $this->_addField('obs', 'obs', 'varchar', 65535, array());
