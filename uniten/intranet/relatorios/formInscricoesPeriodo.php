...
logDao::gravaLog($user->login, 'formAlunoGeral.php', 'Acesso: Pesquisa de Perfil do Aluno Geral', $_REQUEST);
...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
    ...
    <tr>
        <td>
            <form action="resultadoInscricoesPeriodo.php" method="post" name="form1" id="form1">
              <table width="100%" border="0" cellspacing="3" cellpadding="1">
                    <tr>
                        <td colspan="2"><strong>Emitir relatório de inscrições por período.</strong></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr />
