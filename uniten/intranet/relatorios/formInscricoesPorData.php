...
logDao::gravaLog($user->login, 'formInscricoesPorData.php', 'Acesso: Pesquisa de Inscricoes por data da prova', $_REQUEST);
...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
    ...
    <tr>
        <td>
            <form action="resultadoInscricoesPorData.php" method="post" name="form1" id="form1">
              <table width="100%" border="0" cellspacing="3" cellpadding="1">
                    <tr>
                        <td colspan="2"><strong>Emitir relatório de inscrições por data da prova.</strong></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr />
                        ...
                        <tr>
                          ...
                          <td><select name="visualizar" id="visualizar" >
                            <option value="0">Lista de Inscritos</option>
                            <option value="1">Quantidade de Inscritos</option>
                          </select></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
