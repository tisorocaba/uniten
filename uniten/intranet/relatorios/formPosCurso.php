...
logDao::gravaLog($user->login, 'formPosCurso.php', 'Acesso: Pesquisa de poscurso', $_REQUEST);
...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
    ...
    <tr>
        <td>
            <form action="resultadoPosCurso.php" method="post" name="form1" id="form1">
              <table width="100%" border="0" cellspacing="3" cellpadding="1">
                    <tr>
                        <td colspan="2"><strong>Emitir relatório de Pós - Cursos.</strong></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr />
