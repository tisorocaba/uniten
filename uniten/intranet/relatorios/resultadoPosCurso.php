...
$sql = "select  
count(*) as total,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and trabalhando = 1) as trabalhando_sim,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and trabalhando = 0) as trabalhando_nao,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and trabalhando = 1 and registrado = 1) as trabalhando_registrado_sim,  
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and trabalhando = 1 and registrado = 0) as trabalhando_registrado_nao, 
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and trabalhando = 1 and registrado = 0 and autonomo = 1) as trabalhando_como_autonomo_sim,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and trabalhando = 1 and registrado = 0 and autonomo = 0) as trabalhando_como_autonomo_nao,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and estava_empregado = 1) as trabalhava_antes, 
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and era_area = 1) as era_area,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and atendimento = 1) as atendimento_regular,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and atendimento = 2) as atendimento_bom,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and atendimento = 3) as atendimento_otimo,
  (select count(*)  from poscurso P, local_curso L where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."' and curso_ajudou = 1) as curso_ajudou
  
from poscurso P, local_curso L
where local_curso_id = L.id and L.data_inicio >= '".$inicio."' and L.data_termino <= '".$fim."'";
