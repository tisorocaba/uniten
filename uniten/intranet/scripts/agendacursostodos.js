$(document).ready(function(){
    ...
    $("#cbCursos").change(function () {
        self.location='principal.php?acao=agendacursostodos&curso='+this.value;
    })
    ...
    $("#cbLocal").change(function () {
            if($('#cbLocal').val()!=''){
                self.location='principal.php?acao=agendacursostodos&local='+$('#cbLocal').val();
            }
    });
    ...
    $("#btPesquisar").click(function () {
        if($('#busca').val()==''){
            ...
            self.location='principal.php?acao=agendacursostodos&busca='+$('#busca').val();
        }
    });
