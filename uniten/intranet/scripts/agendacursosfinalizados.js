$(document).ready(function(){
    ...
    $("#cbCursos").change(function () {
        self.location='principal.php?acao=agendacursosfinalizados&curso='+this.value;
    })
    ...
    $("#cbLocal").change(function () {
            if($('#cbLocal').val()!=''){
                self.location='principal.php?acao=agendacursosfinalizados&local='+$('#cbLocal').val();
            }
    });
    ...
    $("#btPesquisar").click(function () {
        if($('#busca').val()==''){
            ...
            self.location='principal.php?acao=agendacursosfinalizados&busca='+$('#busca').val();
        }
    });
