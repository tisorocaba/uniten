$(document).ready(function(){
    ...
    $("#cbCursos").change(function () {
        self.location='principal.php?acao=relatoriosClassesFinalizados&curso='+this.value;
    })
    ...
    $("#cbLocal").change(function () {
        if($('#cbLocal').val()!=''){
            self.location='principal.php?acao=relatoriosClassesFinalizados&local='+$('#cbLocal').val();
        }
    });
    ...
    $("#btPesquisar").click(function () {
        if($('#busca').val()==''){
            ...
            self.location='principal.php?acao=relatoriosClassesFinalizados&busca='+$('#busca').val();
        }
    });
