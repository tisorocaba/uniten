                ...
                <td><table width="100%" border="0" style="border: 0px solid black">
                        <tr >
                            ...
                            <td width="21%" align="center"><table width="100%" border="0" height="125" style="border: 1px solid black">
                                    ...
                                    <tr>
                                        <td><span >Revis&atilde;o: 01</span></td>
                                    </tr>
                                    <tr>
                                        <td><span >Data: 04/05/2012</span></td>
                                    </tr>
                                </table></td>
                        </tr>
                    </table></td>
                        ...
                        <td width="1024" align="center"><table width="100%" border="0">
                          <tr>
                            <td width="91%">Pág. 
                              ...
                              <select name="paginacao" id="paginacao" onchange="self.location='relatorio-classe.php?offset='+this.value" style="size:12px">
                                <option value="">---</option>
                                 <?php for($i=1;$i<=ceil($qtalunos/20);$i++){?>
                                 <option value="<?php echo $i;?>" <?php if(@$_GET['offset']==$i) echo 'selected' ?>><?php echo $i;?></option>
                                   <?php } ?>
                              </select>
