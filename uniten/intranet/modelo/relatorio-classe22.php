          ...
          <td><table width="100%" class="comBordaSimples" border="1">
              <tr>
                ...
                <td><table width="100%" cellpadding="8" cellspacing="0" >
                    <tr>
                      <td class="titulo2" colspan="5">Período de <span class="xl741529131"><?php echo data_br(AgendaCurso::staticGet($agenda)->dataInicio) ?></span> a <span><?php echo data_br(AgendaCurso::staticGet($agenda)->dataTermino) ?></span></td>
                    </tr>
                    <tr >
                      <td>  </td>
                      <td>  </td>
...
function ativaPaginacao(){
	...
	self.location='relatorio-classe22.php?offset='+pagina+'&folha='+folha;
}
</script>
