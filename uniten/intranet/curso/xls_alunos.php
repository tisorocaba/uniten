...
if($professorAgendaDao->getDisciplinaPorAgendaProfessor($agenda ,$user->professor)===false){
...
logDao::gravaLog($user->login, 'xls_alunos', 'Exportou: lista de alunos',$_REQUEST,'','Agenda: '.$_REQUEST['agenda']);
...
$rs = $obj->_getConnection()->executeSQL('SELECT   aluno_id as id,
                      ...
                      WHERE local_curso_id = ' . $agenda . ' AND status = 1 ORDER BY classificacao ASC, aluno ASC ');
