...
$codAgenda = (int) $_REQUEST['agenda'];



if (empty($codAgenda)) {
    $_REQUEST['ERRO'] = 'FALTA DE CODIGO';
    logDao::gravaLog($user->login, 'xls_relatorio-classe', 'Erro: Codigo da agenda nao informado', $_REQUEST);
...
if ((int) $user->tipoLogin === 2) {
    if ($professorAgendaDao->getDisciplinaPorAgendaProfessor($codAgenda, $user->professor) === false) {
        ...
        logDao::gravaLog($user->login, 'xls_relatorio-classe', 'ERRO(1058) :: Agenda de outro professor', $_REQUEST,'','Agenda: '.$_REQUEST['agenda']);
        die('ERRO(1058) :: ACESSO NEGADO');
    }
}else{
   if(AgendaCurso::staticGet($codAgenda)->empresaCurso !== $user->empresa->id){
        $_REQUEST['ERRO'] = 'ACESSO NEGADO';
        logDao::gravaLog($user->login, 'xls_relatorio-classe', 'ERRO(1058) :: Agenda de outra empresa ', $_REQUEST,'','Agenda: '.$_REQUEST['agenda']);
        die('ERRO(1058) :: ACESSO NEGADO');
   }
}
...
logDao::gravaLog($user->login, 'xls_relatorio-classe', 'Visualizou: relatorio de classe', $_REQUEST,'','Agenda: '.$_REQUEST['agenda']);




$agendaDao = new AgendaCursoDao();
$agenda = $agendaDao->escape($codAgenda);
        ...
        <div id="relatorio_15291" align=center x:publishsource="Excel">
            ...
            <table border=0 cellpadding=0 cellspacing=0 width=1081 class=xl6615291
                ...
                <tr class=xl6815291 height=35 style='mso-height-source:userset;height:26.25pt'>
                    ...
                    <td class=xl7015291 width=250 style='width:188pt'><img src="http://www.sorocaba.sp.gov.br/images/logo_sorocaba.gif" width="129" height="124"></td>
                    <td class=xl7015291 width=35 style='width:26pt'>&nbsp;</td>
                    <td class=xl7015291 width=19 style='width:14pt'>&nbsp;</td>
    <td class=xl7015291 width=19 style='width:14pt'>&nbsp;</td>
                    <td class=xl7115291 colspan=11 width=209 style='width:154pt'><table width="100%" border="0">
                      <tr>
                          <td><strong>SECRETARIA DE RELAÇÕES DO TRABALHO</strong></td>
                      </tr>
                        <tr>
                          <td><strong><span class="xl7115291" style="width:154pt">RELAT&Oacute;RIO DE
                        CLASSE</span></strong></td>
                        </tr>
                      </table></td>
                    <td class=xl7015291 width=19 style='width:14pt'>&nbsp;</td>
                    <td class=xl7015291 width=19 style='width:14pt'>&nbsp;</td>
                    ...
                    <td class=xl7015291 width=19 style='width:14pt'>&nbsp;</td>
                    <td class=xl7015291 width=19 style='width:14pt'>&nbsp;</td>
                    <td class=xl7015291 width=170 style='width:128pt'>
                    <table width="100%" border="0">
    <tr>
      <td><span class="xl13215291">C&oacute;digo: A05.PR-UNITE-002</span></td>
    </tr>
    <tr>
      <td><span class="xl13215291">Revis&atilde;o: 00</span></td>
    </tr>
    <tr>
      <td><span class="xl13215291">Data: 23/02/2012</span></td>
    </tr>
  </table>
                    </td>
