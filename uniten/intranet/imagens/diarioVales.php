...
<p><span class="titulo">Vale Transporte</span><br />
    ...
    Monitor: <?php echo $diario->professor;?><br />
</p>
    ...
    <p align="center"><input name="imprimir" value="imprimir" type="button" onclick="print();" /> 
<input name="alterar" value="voltar" type="button" onclick="history.go(-1)" /></p>
