...
$alunos = $agendaDao->listaCandidatoAgendaClassificados($_SESSION['CODAGENDA'],@$_REQUEST['aluno']);

$agenda = new AgendaCurso();
$agenda->get($_SESSION['CODAGENDA']);

$user = unserialize($_SESSION['USER']);
logDao::gravaLog($user->login, 'candidatosClassificados', 'Acessou: lista de candidatos classificados', $_REQUEST, '', 'Agenda: ' . $_SESSION['CODAGENDA']);
...
<a href="xls_candidatos_classificados.php?agenda=<?php echo $_SESSION['CODAGENDA']?>" target="_blank">Exportar para Excel</a></p>
      <table width="100%" cellpadding="3" cellspacing="1" class="lista">
        <tr class="listaClara">
          <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="23%"><strong>Listar Candidatos:</strong> 
                    ...
                    <select name="tipoCandidatos" id="tipoCandidatos"  onchange='self.location=this.value'>
                      ...
                      <option value="candidatosClassificados.php" selected="selected">Classificados</option>
            ...
            <tr>
              <td align="center"><strong>Candidatos Classificados </strong></td>
            </tr>
          </table></td>
        </tr>
        <tr class="listaClara">
